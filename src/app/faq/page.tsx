...
function buildFaqs(freeShippingThreshold: string) {
  return [
    ...
    { q: 'Do you offer free shipping?', a: `Free shipping is currently available for orders over $${freeShippingThreshold}. This is subject to change and other promotions. The current free shipping threshold will appear in your shopping cart as you add to your order. Because we keep our costs very low and our product markup in the actual sell price is modest, a small fee for Packaging and Handling costs is still applied and separate from the carrier transport costs that are credited on free shipping amounts.` },
    ...
    { q: 'How long does shipping take?', a: 'Orders are processed within 2–3 business days. Standard delivery within the United States generally takes 5–10 business days from the date of shipment. Contact us for expedited options.' },
    {
      ...
      a: (
        <>
          The Enthronement is the act of formally placing an image of the Sacred Heart of Jesus in a place of honor
          in your home and consecrating your household to His reign. Our{' '}
          <Link href="/shop/27" style={{ color: 'var(--crimson)', textDecoration: 'underline' }}>
            Enthronement Booklet
          </Link>{' '}
          provides a complete guide to this beautiful tradition.
        </>
      ),
    },
