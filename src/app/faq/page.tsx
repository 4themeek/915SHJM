...
function buildFaqs(freeShippingThreshold: string) {
  return [
    ...
    { q: 'Do you offer free shipping?', a: `Free shipping is currently available for orders over $${freeShippingThreshold}. This is subject to change and other promotions. The current free shipping threshold will appear in your shopping cart as you add to your order. A small fee for Packaging and Handling costs is still applied and separate from the carrier transport costs that are credited on free shipping amounts.` },
