...
- [ ] **Test a promo code on a real checkout.** Not yet verified live — create a code at `/admin/settings`, apply it at checkout, confirm the discount shows correctly and Stripe charges the reduced amount.
